layui.use(['form', 'layer', 'layedit', 'laydate', 'upload'], function () {
    ...
    form.verify({
        teacherTitleName: function (value, item) { //value：表单的值、item：表单的DOM对象
            ...
            var meg;
            var teacherTitleId = $("#teacherTitleId").val();
            $.ajax({
                "url": "/admin/teacherTitle/testTeacherTitleName",
                "data": {"teacherTitleName": value, "teacherTitleId": teacherTitleId},
    ...
    form.on("submit(submit)", function (data) {
        ...
        teacherTitleData.teacherTitleId = $("#teacherTitleId").val();
