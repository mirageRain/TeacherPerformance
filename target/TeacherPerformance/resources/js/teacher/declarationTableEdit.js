layui.use(['form', 'layer', 'layedit', 'laydate', 'upload'], function () {
    ...
    form.on("submit(submit)", function (data) {
        ...
        console.log(typeof(uploadListIns.config.files));
        if(typeof (uploadListIns.config.files)== 'object' && JSON.stringify(uploadListIns.config.files) != "{}"){
            ...
            orderData.orderId = parent.declarationTableList[gradingStandardId].orderId;
    ...
    function initFileList() {
        gradingStandardId = parent.gradingStandardId;

        console.log(gradingStandardId);

        var orderFileList = parent.declarationTableList[gradingStandardId].orderFileList;
